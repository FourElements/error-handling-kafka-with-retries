...
@Component
@Slf4j
public class ObjectProducer implements IProducer<String, Object> {

    private final KafkaTemplate<String, Object> template;

    public ObjectProducer(@Qualifier("kafkaTemplateObject") KafkaTemplate<String, Object> template) {
